...
import javax.swing.event.*;
    ...
    public class MathQuiz extends JFrame {
        ...
        int correctCount, wrongCount, correctedCount = 0;
        double result;
        String question;
        ...
        class startListener implements ActionListener {
            public void actionPerformed(ActionEvent e) {
                ...
                if (operator == 1) {
                    ...
                    result = (int)num1 - (int)num2; //formula
                    question = ("" + num1 + "-" + num2); //question label content
                } else if (operator == 3) {
                    result = num1 + num2; //formula
                    question = ("" + num1 + "+" + num2); //question label content
                } else if (operator == 4) {
                    result = (float) num1 / (float) num2; //formula
                    question = ("" + num1 + "/" + num2); //question label content
                } else {
                    result = num1 + num2; //formula
                    question = ("" + num1 + "+" + num2); //question label content
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    if (doubleOfInput == result) {
                        correctCount+= 23;// increasing counter
                        correctedCount++;
                        String stringcount = Integer.toString(correctedCount); // getting integer to string
